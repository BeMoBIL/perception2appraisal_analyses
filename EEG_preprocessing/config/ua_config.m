...
%% General Setup
data_path = 'P:\Izzy_Sander\Data_Analysis\UrbanAppraisal\'; %adjust path to main dir here
bemobil_config.study_folder = [data_path filesep]; %(NEEDS to have a filesep at the end, sorry!) 
bemobil_config.filename_prefix = 'sub-';

% foldernames (NEED to have a filesep at the end, sorry!) 
bemobil_config.raw_EEGLAB_data_folder = ['2_EEGLAB-data' filesep];
...
% bemobil_config.channels_to_remove = ['ECG', 'GSR'];
